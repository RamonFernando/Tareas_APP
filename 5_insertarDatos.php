<?php
    ...
    foreach ($tareas as $tarea) {
        ...
        $check->execute();
        $check->bind_result($existe);       // guarda el resultado en la variable
        $check->fetch();                          // obtiene el valor
        $check->free_result();                    // limpia el resultado para reutilizar la sentencia
